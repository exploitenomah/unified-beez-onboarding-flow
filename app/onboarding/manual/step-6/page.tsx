  ...
  return (
    <>
      <OnboardingStepCardWithHeader
        ...
        type="custom"
        customHeader={<Badge>Step 6/8</Badge>}
        heading="Per-Channel AI Configuration"
        subHeading="We'll customise your AI and automation flows based on your industry. You can change this anytime."
      >
